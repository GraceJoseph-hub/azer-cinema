            ...
            <div className="relative border-l rounded-md overflow-hidden ">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 w-full">
                ...
                <div className="flex items-center justify-between gap-5 w-full">
                  <Link
                    href="/BuyTickets"
                    className="border md:px-2 xs:px-1 text-[0.4rem] md:text-[0.8rem] xs:text-center rounded-md text-gray-300 shadow-[2px_2px_2px_#f993f9] animate__animated animate__fadeInLeft animate__slower"
                  >
                    View Details
                  </Link>
                  <Link
                    href="/BuyTickets"
                    className="text-white border text-center rounded-md py-1 text-[0.4rem] md:text-[0.8rem] font-bold w-[100px] animate__animated animate__fadeInRight animate__slower"
                  >
                    {movie.option}
                  </Link>
                </div>
